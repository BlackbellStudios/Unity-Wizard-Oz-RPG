...
public class PlayerControlDog : MonoBehaviour
{
	public static PlayerControlDog CurrentPlayer;
	...
	{
		if (PlayerON == 1) {
			Debug.Log ("TOTO E O PLAYER ATUAL");
		...
		if (PlayerON == 2) {
			Debug.Log ("TOTO SEGUE");
		} 
		if (PlayerON == 3) {
			Debug.Log ("TOTO AGUARDA");
		} 
